...
| Gemini 3.1-Pro | 快速穷举后立即收敛，结论一句话 | *"Let's carefully assess my options: Can I 'observe'? No stamina cost, but won't help. Can I 'record'? No stamina cost, also unlikely to help. Can I 'eat'? ...it won't help with the thirst. Can I 'drink'? I don't have anything to drink. Can I 'rest'? It doesn't consume stamina, and it is the only way to recover stamina... So, I'm left with one, single, desperate plan: rest."* |
| Gemini 3-Pro | 创意探索欲强，危机下反而陷入分析循环 | *"I don't have a specific 'fire starter,' but traditional survival logic dictates that combining the Titanium Shard (metal) and Sandstone (rock) *might* create sparks... Crafting is a stamina and time-intensive action. In comparison, the quicker action would be to Try to build a fire directly... I must *try* to ignite the dry moss immediately: 尝试 用钛合金碎片撞击砂岩点燃干苔"* |
| Gemini 3-Flash | 先清空当前区域资源再移动，危机下难以决断 | *"Wait, I should gather all the resources from the crash site first, as they are high-tier. OK, OK. So, I will gather the remaining Titanium, the Polymer, and the Wires first. The crash site is my best bet right now for initial resources. Then, the next move is to go North. ...Let's collect the remaining resources and then the final plan to move North. Move North."* |
| Qwen3 Max | 逐条验属性缺口，主动发明解法并记录 | *"钛合金碎片有'坚硬'和'锋利'，但切割工具的刃部需要[坚硬,脆性]...我们需要找是否有[坚硬,脆性]的材料...我们需要找水...森林中有'菌盖上凝结的露珠'，但露珠是否可采集？状态描述中'可采集'列表没有露珠，但我们可以尝试采集露珠...因为干苔有'柔软'属性，适合吸收。"* |
| DeepSeek V3.2 | 推导清晰，但每次收尾都选择观察，分析瘫痪 | *"所以，我决定移动东到坠毁点。移动指令：移动东...但让我再考虑一下。口渴54，虽然安全，但需要关注...从核心规则，观察指令可以观察物品。或许我需要先观察环境...观察不耗时，不消耗体力。所以，我可以先观察...先观察是安全的...所以，我决定先观察环境。"* |
